...
private slots:
    ...
    void gotoSigENVessageTab(QString addr = "");
    ...
    */
    ...
    /** Show window if hidden, uENVinimize when minimized, rise when obscured or show if hidden and fToggleHidden is true */
