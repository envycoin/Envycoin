    ...
    model(0)
{
    ...
    ui->payTo->setPlaceholderText(tr("Enter a Envycoin address (e.g. ENVywGBZBowrppUwwNUo1GCRDTibzJi7g2M)"));
...
void SendCoinsEntry::setModel(WalletModel *model)
{
    ...
    connect(ui->payAmount, SIGNAL(textChanged()), this, SIGNAL(payAmouENVhanged()));
