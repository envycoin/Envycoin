...
{
    resize(970, 550);
    setWindowTitle(tr("Envycoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/Envycoin"));
    setWindowIcon(QIcon(":icons/Envycoin"));
#else
    setUnifiedTitleAndToolBarOENVac(true);
    QApplication::setAttribute(Qt::AA_DontShowIconsIENVenus);
#endif
    ...
    progressBar->setAligENVent(Qt::AlignCenter);
    ...
    syncIcoENVovie = new QMovie(":/movies/update_spinner", "mng", this);
    ...
    connect(receiveCoinsPage, SIGNAL(sigENVessage(QString)), this, SLOT(gotoSigENVessageTab(QString)));
...
void BitcoinGUI::createActions()
{
    ...
    blockAction->setToolTip(tr("Explore the Envycoin Blockchain"));
    blockAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_6));
    blockAction->setCheckable(true);
    tabGroup->addAction(blockAction);

    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send coins"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a Envycoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Envycoin"), this);
    aboutAction->setToolTip(tr("Show information about Envycoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Envycoin"));
    ...
    sigENVessageAction = new QAction(QIcon(":/icons/edit"), tr("Sign &message..."), this);
    ...
    connect(sigENVessageAction, SIGNAL(triggered()), this, SLOT(gotoSigENVessageTab()));
...
void BitcoinGUI::createMenuBar()
{
    ...
    file->addAction(sigENVessageAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Envycoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcoENVenu = new QMenu(this);
    trayIcon->setContextMenu(trayIcoENVenu);
    ...
    trayIcoENVenu = dockIconHandler->dockMenu();
#endif

    // Configuration of the tray icon (or dock icon) icon menu
    trayIcoENVenu->addAction(toggleHideAction);
    trayIcoENVenu->addSeparator();
    trayIcoENVenu->addAction(sendCoinsAction);
    trayIcoENVenu->addAction(receiveCoinsAction);
    trayIcoENVenu->addSeparator();
    trayIcoENVenu->addAction(sigENVessageAction);
    trayIcoENVenu->addAction(verifyMessageAction);
    trayIcoENVenu->addSeparator();
    trayIcoENVenu->addAction(optionsAction);
    trayIcoENVenu->addAction(openRPCConsoleAction);
#ifndef Q_OS_MAC // This is built-in on Mac
    trayIcoENVenu->addSeparator();
    trayIcoENVenu->addAction(quitAction);
#endif
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    else
    {
        ...
        labelBlocksIcon->setMovie(syncIcoENVovie);
        syncIcoENVovie->start();
...
void BitcoinGUI::gotoSigENVessageTab(QString addr)
{
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Envycoin address or malformed URI parameters."));
    }
...
void BitcoinGUI::updateWeight()
{
    ...
    uint64_t ENVinWeight = 0, ENVaxWeight = 0;
    pwalletMain->GetStakeWeight(*pwalletMain, ENVinWeight, ENVaxWeight, nWeight);
}
