    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Envycoin address (e.g. ENVywGBZBowrppUwwNUo1GCRDTibzJi7g2M)"));
#endif
...
SendCoinsEntry *SendCoinsDialog::addEntry()
{
    ...
    connect(entry, SIGNAL(payAmouENVhanged()), this, SLOT(coinControlUpdateLabels()));
