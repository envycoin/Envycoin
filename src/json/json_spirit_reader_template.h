...
namespace json_spirit
{
    ...
    private:
        ...
        Semantic_actions& operator=( const Semantic_actions& ); 
                                    // to prevent "assigENVent operator could not be generated" warning
    ...
    private:
        ...
        Json_grammer& operator=( const Json_grammer& ); // to prevent "assigENVent operator could not be generated" warning
